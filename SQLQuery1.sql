...
-- Filtering out locations that are already included in our data
...
-- I want to do a rolling count that sums up tha vaccinated and adds them up
...
-- Here we get the % of cases based on the population of each country
